...
class TestApplyTransactionCommand(unittest.TestCase):
    ...
    def test_command_execute_and_undo_multiple(self):
        ...
        command1 = ApplyTransactionCommand(self.balance, Transaction(100, TransactionCategory.INCOME))
        command2 = ApplyTransactionCommand(self.balance, Transaction(50, TransactionCategory.EXPENSE))
...
class TestCommandHistory(unittest.TestCase):
    ...
    def test_execute_multiple_commands(self):
        ...
        command1 = ApplyTransactionCommand(self.balance, Transaction(100, TransactionCategory.INCOME))
        command2 = ApplyTransactionCommand(self.balance, Transaction(30, TransactionCategory.EXPENSE))
    ...
    def test_redo_cleared_on_new_command(self):
        """Test that redo stack is cleared when a new command is executed after undo."""
        command1 = ApplyTransactionCommand(self.balance, Transaction(100, TransactionCategory.INCOME))
        command2 = ApplyTransactionCommand(self.balance, Transaction(50, TransactionCategory.EXPENSE))
        ...
        command3 = ApplyTransactionCommand(self.balance, Transaction(25, TransactionCategory.INCOME))
